...
export const GetSurveyCardDocument = gql`
  ...
  export class GetSurveyCardGQL extends Apollo.Query<GetSurveyCardQuery, GetSurveyCardQueryVariables> {
    override document = GetSurveyCardDocument;
