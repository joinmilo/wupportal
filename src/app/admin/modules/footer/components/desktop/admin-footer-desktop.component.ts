...
@Component({
  selector: 'app-admin-footer-desktop',
  templateUrl: './admin-footer-desktop.component.html',
  styleUrls: ['./admin-footer-desktop.component.scss'],
})
export class AdminFooterDesktopComponent {
